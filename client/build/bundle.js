...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Sample = __webpack_require__(160);
	...
	var BankBox = React.createClass({
		...
		separateAccounts: function separateAccounts(type) {
		...
		getTotal: function getTotal(accounts) {
			var accountValues = accounts.map(function (account) {
				return account.amount;
			});
			return accountValues.reduce(function (a, b) {
				return a + parseInt(b);
			});
		},
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(AccountBox, { accounts: personalAccounts,
					total: personalTotal }),
				React.createElement(AccountBox, { accounts: businessAccounts,
					total: businessTotal }),
				React.createElement(
					'h2',
					null,
					' Total Bank Value: ',
					this.getTotal(this.state.accounts)
				),
				React.createElement(
					'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Account = __webpack_require__(162);
	...
	var AccountBox = React.createClass({
		...
		render: function render() {
			...
			var allAccounts = this.props.accounts.map(function (account) {
				return React.createElement(Account, { account: account });
			});
